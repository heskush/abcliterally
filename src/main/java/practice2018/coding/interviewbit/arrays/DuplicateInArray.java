...
public class DuplicateInArray {
  ...
  public static int repeatedNumber(List<Integer> a) {
    ...
    int n = a.size() - 1;
    long shouldBeSum = n * ((n + 1) / 2);
    if (sum == shouldBeSum) {
      return -1;
    } else {
      return (int) (sum - shouldBeSum);
    }
